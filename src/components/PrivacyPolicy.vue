  ...
  <div id="wrap" style="text-align: left;">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tab-content">
              ...
              <br />
              <br />
              <p>Effective date: November 16, 2019</p>
              <p>
                FLIBO ("us", "we", or "our") operates the https://flibo.ai
              ...
              <p>
                ...
                Policy for FLIBO has been created with the help of
              ...
              <ul>
                <li>
                  ...
                  <p>
                    Service is the https://flibo.ai website operated by FLIBO
                  </p>
                </li>
                <li>
              ...
              <br />
              <h2>Use of Data</h2>
              <p>FLIBO uses the collected data for various purposes:</p>
              <ul>
              ...
              <p>
                FLIBO will take all steps reasonably necessary to ensure that
              ...
              <p>
                FLIBO may disclose your Personal Data in the good faith belief
                that such action is necessary to:
              </p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of FLIBO</li>
                <li>
              ...
              <p>
                ...
                contact us by send an email to:
              </p>
              <ul>
                <li>contact@flibo.ai</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="page-footer">
      <div class="policy-container">
        <div class="row">
          <div class="col-md-12">
            Privacy Policy of https://flibo.ai
          </div>
        </div>
      </div>
    </div>
